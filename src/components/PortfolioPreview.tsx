...
export default function PortfolioPreview(props: {portfolio_id: string}) {
  ...
  return (
    <div class="relative w-full max-w-full py-4">
      ...
      <div class="rounded-l-[3px] font-mono absolute bottom-8 -right-6 text-5xl text-bymuno-blue-0 bg-bymuno-grey-3 bg-opacity-50 px-3 pt-1 pb-3 pointer-events-none select-none">
