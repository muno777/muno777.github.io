...
var gfyObject = function (gfyElem) {
    ...
    function createCtrlBox() {
        ...
        ctrlBox.className = "CtrlBox";
		  ctrlLink = document.createElement('a');
		  ctrlLink.className = "CtrlLink";
		  ctrlLink.style.fontStyle = 'italic';
		  ctrlLink.style.fontWeight = 'bold';
		  ctrlLink.style.fontSize = '12px';
		  ctrlLink.href = "https://gfycat.com/" + gfyId;
		  ctrlLink.target = "_blank";
		  ctrlLink.innerHTML = gfyItem.title + " <i class='fa fa-external-link' aria-hidden='true'></i>";
        ctrlPausePlay = document.createElement('img');
        ctrlPausePlay.className = "gfyCtrlPause";
        ctrlPausePlay.src = "../../../assets.gfycat.com/img/placeholder.png";
        ctrlPausePlay.style.backgroundImage = "url('../../../assets.gfycat.com/img/gfycontrols.png')";
        ...
        ctrlReverse.src = "../../../assets.gfycat.com/img/placeholder.png";
        ctrlReverse.style.backgroundImage = "url('../../../assets.gfycat.com/img/gfycontrols.png')";
        ...
        ctrlSlower.src = "../../../assets.gfycat.com/img/placeholder.png";
        ctrlSlower.style.backgroundImage = "url('../../../assets.gfycat.com/img/gfycontrols.png')";
        ...
        ctrlFaster.src = "../../../assets.gfycat.com/img/placeholder.png";
        ctrlFaster.style.backgroundImage = "url('../../../assets.gfycat.com/img/gfycontrols.png')";
